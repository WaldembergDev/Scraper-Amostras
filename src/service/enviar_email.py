...
class EnviarEmail:
    ...
    def enviar_email(cls, dados: list):
        ...
        msg['Subject'] = assunto
        msg['From'] = remetente
        msg['To'] = 'rayara@qualylab.com.br, gestaolab@qualylab.com.br, ti@grupoqualityambiental.com.br, financeiro@grupoqualityambiental.com.br, adm@qualylab.com.br, laboratorio@qualylab.com.br, servicosanaliticos@qualylab.com.br'
